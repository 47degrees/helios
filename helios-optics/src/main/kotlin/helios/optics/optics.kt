...
@PublishedApi
internal val boolean = Prism.fromOption<Json, JsBoolean> { it.asJsBoolean() }
...
@PublishedApi
internal val string = Prism.fromOption<Json, JsString> { it.asJsString() }
...
@PublishedApi
internal val array = Prism.fromOption<Json, JsArray> { it.asJsArray() }
...
@PublishedApi
internal val `object` = Prism.fromOption<Json, JsObject> { it.asJsObject() }
...
@PublishedApi
internal val `null` = Prism.fromOption<Json, JsNull> { it.asJsNull() }
inline val Json.Companion.jsNull: Prism<Json, JsNull>
  inline get() = `null`

@PublishedApi
internal val number = Prism.fromOption<Json, JsNumber> { (it as? JsNumber).toOption() }
inline val Json.Companion.jsNumber: Prism<Json, JsNumber>
  inline get() = number

@PublishedApi
internal val double = Prism.fromOption<JsNumber, JsDouble> { JsDouble(it.toDouble()).some() }
...
@PublishedApi
internal val float = Prism.fromOption<JsNumber, JsFloat> { JsFloat(it.toDouble().toFloat()).some() }
...
@PublishedApi
internal val long = Prism.fromOption<JsNumber, JsLong> { it.toLong().map(::JsLong) }
