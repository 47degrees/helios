...
data class ParseException(val msg: String, val index: Int, val line: Int, val col: Int) : Exception(msg)
...
interface Parser<J> {
    ...
    tailrec fun parse(i: Int, facade: Facade<J>): Pair<J, Int> =
            ...
            // duties to our good friend rparse().
                '[' -> rparse(ARRBEG, i + 1, listOf(facade.arrayContext()), facade)
                '{' -> rparse(OBJBEG, i + 1, listOf(facade.objectContext()), facade)
     ...
     * improvements.
     */
    tailrec fun rparse(state: Int, j: Int, stack: List<FContext<J>>, facade: Facade<J>): Pair<J, Int> {
        val i = reset(j)
