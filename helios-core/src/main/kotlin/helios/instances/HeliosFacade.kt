...
object HeliosFacade : Facade<Json> {
    override fun singleContext(): FContext<Json> = object : FContext<Json> {
        ...
        override fun add(s: CharSequence): Unit { value = jstring(s.toString()) }
        override fun add(v: Json): Unit { value = v }
    ...
    override fun arrayContext(): FContext<Json> = object : FContext<Json> {
        ...
        override fun add(s: CharSequence): Unit { vs += jstring(s.toString()) }
        override fun add(v: Json): Unit { vs += v }
    ...
    override fun jnum(s: CharSequence, decIndex: Int, expIndex: Int): Json = if (decIndex < 0 && expIndex < 0) {
